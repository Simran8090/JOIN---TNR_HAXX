...
TOKEN = '6919121939:AAHI9S5P5O2eoOybdDbX7DSsnu9iqeA9WY4'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002402140397
CHANNEL_ID = -1002402140397
error_channel_id = -1002402140397
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/NUCLEAR_VIPDoDS")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/VIPMODXOWNER")
    markup.add(button3)
    markup.add(button1)
    return markup
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    ...
    bot.send_message(chat_id, "*💎 𝐃𝐄𝐀𝐑 𝐕𝐈𝐏 𝐔𝐒𝐄𝐑 💎!.*\n"
                               "*𝐘𝐎𝐔𝐑 𝐀𝐓𝐓𝐀𝐂𝐊 𝐅𝐈𝐍𝐈𝐒𝐇𝐄𝐃.*\n"
                               "*𝐓𝐇𝐀𝐍𝐊𝐒 𝐘𝐎𝐔 𝐅𝐎𝐑 𝐔𝐒𝐈𝐍𝐆 𝐎𝐔𝐑 𝐒𝐄𝐑𝐕𝐈𝐂𝐄 🚀!*", 
                               reply_markup=create_inline_keyboard(), parse_mode='Markdown')
...
def approve_or_disapprove_user(message):
    ...
    if not is_admin:
        bot.send_message(
            chat_id,
            "🚫 *ACESS DENIED BRO YOUR PLAN EXPERIED OR INVALID!*\n"
...
def handle_attack_command(message):
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 ACESS DENIED BRO YOUR PLAN EXPERIED OR INVALID!*\n"
                                       "*GET ACCESS DM TO ADMIN OR OWNER.*\n"
                                       "*Contact the owner => @VIPMODXOWNER.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
        ...
        bot.send_message(chat_id, "*💣 𝐑𝐞𝐚𝐝𝐲 𝐭𝐨 𝐥𝐚𝐮𝐧𝐜𝐡 𝐚𝐧 𝐚𝐭𝐭𝐚𝐜𝐤?*\n"
                                   "*𝐏𝐥𝐞𝐚𝐬𝐞 𝐩𝐫𝐨𝐯𝐢𝐝𝐞 𝐭𝐡𝐞 𝐭𝐚𝐫𝐠𝐞𝐭 𝐈𝐏, 𝐩𝐨𝐫𝐭, 𝐚𝐧𝐝 𝐝𝐮𝐫𝐚𝐭𝐢𝐨𝐧 𝐢𝐧 𝐬𝐞𝐜𝐨𝐧𝐝𝐬.*\n"
                                   "*𝐄𝐱𝐚𝐦𝐩𝐥𝐞: 𝟏𝟔𝟕.𝟔𝟕.𝟐𝟓 𝟔𝟐𝟗𝟔 𝟔𝟎* 🤖\n"
                                   "*𝐁𝐠𝐦𝐢 𝐤𝐢 𝐛𝐡𝐞𝐧 𝐜𝐡𝐨𝐝 𝐝𝐞 💀*", 
                                   reply_markup=create_inline_keyboard(), parse_mode='Markdown')
...
def process_attack_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration > 1500:
            bot.send_message(message.chat.id, "*⏳ Maximum duration is 1500 seconds.*\n"
        ...
        bot.send_message(message.chat.id, f"*🚀YOUR ATTACK ON THE WAY!🚀*\n\n"
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/NUCLEAR_VIPDoDS")
            markup.add(button1)
            markup.add(button2)
        else:
...
def start_message(message):
    try:
        bot.send_message(message.chat.id,  "* 🌍 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!* 🎉\n\n"
                                           "*🚀 𝐆𝐞𝐭 𝐫𝐞𝐚𝐝𝐲 𝐭𝐨 𝐝𝐢𝐯𝐞 𝐢𝐧𝐭𝐨 𝐭𝐡𝐞 𝐚𝐜𝐭𝐢𝐨𝐧!*\n\n"
                                           "*💣 𝐓𝐨 𝐮𝐧𝐥𝐞𝐚𝐬𝐡 𝐲𝐨𝐮𝐫 𝐩𝐨𝐰𝐞𝐫, 𝐮𝐬𝐞 𝐭𝐡𝐞* /attack *𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐟𝐨𝐥𝐥𝐨𝐰𝐞𝐝 𝐛𝐲 𝐲𝐨𝐮𝐫 𝐭𝐚𝐫𝐠𝐞𝐭'𝐬 𝐈𝐏 𝐚𝐧𝐝 𝐩𝐨𝐫𝐭.* ⚔️\n\n"
                                           "*🔍 𝐄𝐱𝐚𝐦𝐩𝐥𝐞: 𝐀𝐟𝐭𝐞𝐫* /attack , *enter:* `𝐢𝐩 𝐩𝐨𝐫𝐭 𝐝𝐮𝐫𝐚𝐭𝐢𝐨𝐧`.\n\n"
                                           "*🔥 𝐄𝐧𝐬𝐮𝐫𝐞 𝐲𝐨𝐮𝐫 𝐭𝐚𝐫𝐠𝐞𝐭 𝐢𝐬 𝐥𝐨𝐜𝐤𝐞𝐝 𝐢𝐧 𝐛𝐞𝐟𝐨𝐫𝐞 𝐲𝐨𝐮 𝐬𝐭𝐫𝐢𝐤𝐞!*\n\n"
                                           "*📚 𝐍𝐞𝐰 𝐚𝐫𝐨𝐮𝐧𝐝 𝐡𝐞𝐫𝐞? 𝐂𝐡𝐞𝐜𝐤 𝐨𝐮𝐭 𝐭𝐡𝐞* /help *𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐭𝐨 𝐝𝐢𝐬𝐜𝐨𝐯𝐞𝐫 𝐚𝐥𝐥 𝐦𝐲 𝐜𝐚𝐩𝐚𝐛𝐢𝐥𝐢𝐭𝐢𝐞𝐬.* 📜\n\n"
...
def canary_command(message):
    ...
    button1 = types.InlineKeyboardButton(
        ...
        url="https://t.me/NUCLEAR_VIPDoDS")
    button2 = types.InlineKeyboardButton(
